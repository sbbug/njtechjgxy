...
@Component
public interface TeacherPaperCheckResultMapper {

	
	//查询所有数据接口定义
	@Select("select * from jgxy_teacher_paper_check_result")
	public List<PaperCheckResult> getAllPaperCheckResult();
	
	//根据教师工号与论文名称查询记录
	@Select("select * from jgxy_teacher_paper_check_result where paper_title=#{paper_title} and teacher_num=#{teacher_num}")
	public PaperCheckResult getPaperByPapernameAndTeachernum(@Param("paper_title") String paper_title,@Param("teacher_num")String teacher_num);
	
	//根据教师工号与论文名称修改数据
	@Update("update jgxy_teacher_paper_check_result set is_in_own=#{is_in_own},"
	...
	//插入数据的接口定义
	@Insert("insert into jgxy_teacher_paper_check_result ("
			                                                + "is_in_own,"
			                                                + "is_in_peking,"
			                                                + "is_in_scd,"
			                                                + "is_in_ssci,"
