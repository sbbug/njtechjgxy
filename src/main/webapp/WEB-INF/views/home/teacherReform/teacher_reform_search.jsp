					  ...
					  <table class="table">
							...
							<c:forEach items = "${pageReforms}" var = "reform">
							          <tr>
							              ...
							              <td>${reform_remark}</td>				             						           
							              <td><a href='<%=request.getContextPath() %>/tea_reform/modify_reform?reform_title=${reform.reform_title}'>修改</a></td>
							              <td><a href='<%=request.getContextPath() %>/tea_reform_check_result/index?reform_title=${reform.reform_title}'>审核结果</a></td>
							          </tr>                                                   
                            </c:forEach>
							
					  </table>
					  															       			
					       <a href="<%=request.getContextPath() %>/tea_reform/search?which=pre">上一页</a>
					 
					       <a href="<%=request.getContextPath() %>/tea_reform/search?which=next">下一页</a>
