...
<body>
   <div class="main">
       <h2>教学教改信息提交</h2>
		   <form class="form-inline" method="post" action="<%=request.getContextPath() %>/tea_reform/addReform" enctype ="multipart/form-data">
		            <div class="table-responsive">
					  <table class="table">
                            ...
                            <tr class="active">
							      ...
							      <td>
							           <input type="text" name = "reform_first_author" class="form-control"  placeholder="姓名">
							      </td>
							      <td>
							            <label for="exampleInputName2">第二作者</label>
							      </td>
							      <td>      
							            <input type="text" name="reform_second_author" class="form-control"  placeholder="姓名">
							      </td>
							</tr>
							<tr class="active">
							      <td>
							      ...
							      <td>
							           <input type="text" name="reform_third_author" class="form-control"  placeholder="姓名">
							      </td>
							      <td>
							            <label for="exampleInputName2">其他作者</label>
							      </td>
							      <td>      
							            <input type="text" name="reform_other_author" class="form-control"  placeholder="单位">
							      </td>
							</tr>
							...
							<tr class="active">
							      ...
							      <td>
							            <input type="text" name="reform_title" class="form-control"  placeholder="项目名称">
							      </td>
							      <td>
							            <label for="exampleInputName2">发奖单位</label> 
							      </td>
							      <td>
							             <input type="text" name="reform_give_reward_unit" class="form-control"  placeholder="期刊名称">
							      </td>
							</tr>
							...
							<tr class="active">
							     <td>
							      ...
							      <td>      
							            <input type="text" name="reform_money" class="form-control"  placeholder="金额">
							      </td>
							</tr>
							<tr class="active">
							      <td> 
	                              ...
	                              <td>						     
							          <input id="datetimepicker_start" type="text" name="reform_start_date" class="form-control" class="form_datetime" placeholder="开始时间"> 
							      </td>
							      ...
							      <td>
							          <input id="datetimepicker_end" type="text" name="reform_end_date" class="form-control" class="form_datetime" placeholder="结束时间"> 
							      </td>
							</tr>
							<tr class="active">
							      <td> 
							      ...
							      <td colspan="3">
							           <textarea  name = "reform_remark" class="form-control" >
