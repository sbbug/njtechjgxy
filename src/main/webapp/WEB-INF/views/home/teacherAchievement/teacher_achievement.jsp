...
<body>
   <div class="main">
       <h2>成果信息申报信息提交</h2>
		   <form class="form-inline" method="post" action="<%=request.getContextPath() %>/tea_achievement/add_achievement" enctype ="multipart/form-data">
		            <div class="table-responsive">
					  <table class="table">
                            ...
                            <tr class="active">
							      ...
							      <td>
							           <input type="text" name = "achieve_teacher_name" class="form-control"  placeholder="姓名">
							      </td>
							      <td>
							...
							<tr class="active">
							      ...
							      <td>
							           <input type="text" name="achieve_title" class="form-control"  placeholder="名称">
							      </td>
							      <td>
							           <label for="exampleInputName2">项目所属类别</label>
							      </td>
							      <td>      
							             <input type="text"  name="achieve_class" class="form-control"  placeholder="类别">
							      </td>
							</tr>						
							...
							<tr class="active">
							      ...
							      <td>
							            <input type="text" name="achieve_unit_awards" class="form-control"  placeholder="单位">
							      </td>
							      <td>
							              <label for="exampleInputName2">获奖时间</label>  
							      </td>
							      <td>
							              <input type="text" id = "achieve_get_time" name="achieve_get_time" class="form-control"  placeholder="时间">
							      </td>
							</tr>
							...
							<tr class="active">
							     <td>
							      ...
							      <td>
							                 <!-- 下面的数据采用动态提取 -->
				                     <select id="static_dropdown_4" name="achieve_rank" class="form-control">
							      ...
							      <td>      
							           <select id="static_dropdown_4" name="achieve_which" class="form-control">
							...
							<tr class="active">
							      ...
							      <td colspan="3">
							           <textarea  name = "achieve_remark" class="form-control" >
