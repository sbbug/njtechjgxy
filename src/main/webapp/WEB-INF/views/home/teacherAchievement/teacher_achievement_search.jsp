					  ...
					  <table class="table">
							...
							<c:forEach items = "${pageAchievements}" var = "achieve">
							          <tr>
							              ...
							              <td><a href='<%=request.getContextPath() %>/tea_achievement/modify_achieve?achieve_title=${achieve.achieve_title}'>修改</a></td>
							              <td><a href='<%=request.getContextPath() %>/tea_achieve_check_result/index?achieve_title=${achieve.achieve_title}'>审核结果</a></td>
							          </tr>                                                   
                            </c:forEach>
							
					  </table>
					  															       			
					       <a href="<%=request.getContextPath() %>/tea_achievement/search?which=pre">上一页</a>
					 
					       <a href="<%=request.getContextPath() %>/tea_achievement/search?which=next">下一页</a>
