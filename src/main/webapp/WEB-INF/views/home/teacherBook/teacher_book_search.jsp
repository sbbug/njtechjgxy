					  ...
					  <table class="table">
							...
							<c:forEach items = "${pageBooks}" var = "book">
							          <tr>
							              ...
							              <td><a href='<%=request.getContextPath() %>/tea_book/modify_book?book_name=${book.book_name}'>修改</a></td>
							              <td><a href='<%=request.getContextPath() %>/tea_book_check_result/index?book_name=${book.book_name}'>审核结果</a></td>
							          </tr>                                                   
                            </c:forEach>
							
					  </table>
					  															       			
					       <a href="<%=request.getContextPath() %>/tea_book/search?which=pre">上一页</a>
					 
					       <a href="<%=request.getContextPath() %>/tea_book/search?which=next">下一页</a>
