...
<body>
   <div class="main">
       <h2>著作教材申报信息提交</h2>
		   <form class="form-inline" method="post" action="<%=request.getContextPath() %>/tea_book/modify_save_book" enctype ="multipart/form-data">
					  ...
					  <table class="table">
							...
							<tr class="active">
							     ...
							     <td> 
								    ...
								    <label class="radio">
								     ...
								     <c:choose>
								               <c:when test="${book.book_status == 1}">
								                       <script>
								                       $("input[name='book_status']").get(0).checked=true
								                       </script>
								               </c:when>
								               <c:otherwise>
								                       <script>
								                       $("input[name='book_status']").get(1).checked=true
								                       </script>                              
								               </c:otherwise>
							         </c:choose>
								 </td>
							...
							<tr class="active">
							      ...
							      <td>
                                     ...
                                     <script>
                                     $("#static_dropdown_1").val('${book.book_department}');
                                     </script>
							      </td>
							      <td></td>
							      <td></td>
							   ...
							   <td> <label class="radio">著作类别：     </label></td>
							      ...
							      <td>
				                     ...
				                     <select id="static_dropdown_2" name="book_category_class" class="form-control">
                                      ...
                                      <script>
                                     $("#static_dropdown_2").val('${book.book_category_class}');
                                     </script>
							      </td>
							      <td>
							      ...
							      <td>
				                     ...
				                     <select id="static_dropdown_3" name="book_copyright_type" class="form-control">
                                      ...
                                      <script>
                                     $("#static_dropdown_3").val('${book.book_copyright_type}');
                                     </script>
							      </td>
							</tr>
                            <tr class="active">
							      ...
							      <td>
							           <input type="text" name = "book_first_author" value="${book.book_first_author}" class="form-control"  placeholder="姓名">
							      </td>
							      <td>
							...
							<tr class="active">
							      ...
							      <td>
							           <input type="text" name="book_second_author" value="${book.book_second_author}" class="form-control"  placeholder="姓名">
							      </td>
							      <td>
							...
							<tr class="active">
							      ...
							      <td>
							           <input type="text" value="${book.book_third_author}" name="book_third_author" class="form-control"  placeholder="姓名">
							      </td>
							      <td>
							...
							<tr class="active">
							      ...
							      <td>
							            <input type="text" name="book_name" value="${book.book_name}"class="form-control"  placeholder="书籍名称">
							      </td>
							      <td>
							              <label for="exampleInputName2">出版社名称</label>  
							      </td>
							      <td>
							              <input type="text" name="book_press_name" value="${book.book_press_name}" class="form-control"  placeholder="出版社">
							      </td>
							</tr>
							     ...
							     <td>
							      ...
							      <td>
				                     ...
				                     <select id="static_dropdown_4" name="book_which" class="form-control">
                                       ...
                                       <script>
                                     $("#static_dropdown_4").val('${book.book_which}');
                                     </script>
							      </td>
							      <td>
							      ...
							      <td>      
							          <input type="text" name="book_words" value="${book.book_words}" class="form-control"  placeholder="字数">
							      </td>
							</tr>
							<tr class="active">
							      <td> 
							      ...
							      <td>
							           <input type="text" id="book_publish_date" name="book_publish_date" value="${book.book_publish_date}" class="form-control"  placeholder="出版时间">
							      </td>
							      <td>
							...
							<tr class="active">
	                              ...
	                              <td>						     
							          <input type="text" name="book_remark" value="${book.book_remark}" class="form-control"  placeholder="填写备注"> 
							      </td>
							      <td>
