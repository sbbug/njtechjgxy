...
<body>
   <div class="main">
       <h2>专利申报信息提交</h2>
		   <form class="form-inline" method="post" action="<%=request.getContextPath() %>/tea_patent/addPatent" enctype ="multipart/form-data">
		            <div class="table-responsive">
					  <table class="table">
                            ...
                            <tr class="active">
							      ...
							      <td>
							           <input type="text" name = "patent_first_author" class="form-control"  placeholder="姓名">
							      </td>
							      <td>
							            <label for="exampleInputName2">第二作者</label>
							      </td>
							      <td>      
							            <input type="text" name="patent_second_author" class="form-control"  placeholder="姓名">
							      </td>
							</tr>
							<tr class="active">
							      <td>
							      ...
							      <td>
							           <input type="text" name="patent_third_author" class="form-control"  placeholder="姓名">
							      </td>
							      <td>
							            <label for="exampleInputName2">其他作者</label>
							      </td>
							      <td>      
							            <input type="text" name="patent_other_author" class="form-control"  placeholder="多个姓名">
							      </td>
							</tr>
							<tr class="active">
							      <td>
							      ...
							      <td>
							           <input type="text"  name="patent_class" class="form-control"  placeholder="专利类别">
							      </td>
							      <td>
							            <label for="exampleInputName2">专利名称</label>
							      </td>
							      <td>      
							            <input type="text"  name="patent_title" class="form-control"  placeholder="专利名称">
							      </td>
							</tr>
							...
							<tr class="active">
							      ...
							      <td>
							            <input type="text" name="patent_num" class="form-control"  placeholder="专利号">
							      </td>
							      <td></td>
							      <td>
							      </td>
