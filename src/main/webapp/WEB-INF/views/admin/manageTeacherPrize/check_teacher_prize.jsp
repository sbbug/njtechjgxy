...
<body>
   <div class="main">
       <h2>竞赛项目审核</h2>
		   <form class="form-inline" method="post" action="<%=request.getContextPath() %>/admin_prize/save_result" >
					  ...
					  <table class="table">
					  		<tr class="active">
							     <td>
							      ...
							      <td>
							           <input type="text" name="result_rank" class="form-control" value="${prizeCheckResult.result_rank}"  placeholder="项目等级">
							      </td>
							      <td>
							...
							<tr class="active">
							     ...
							     <td> 
								    ...
								    <label class="radio">
								     ...
								     <c:choose>
								               <c:when test="${prizeCheckResult.result_is_ok== 1}">
								                       <script>
								                       $("input[name='result_is_ok']").get(0).checked=true;
								                       </script>
								               </c:when>
								               <c:when test="${prizeCheckResult.result_is_ok== 2}">
								                       <script>
							...
							<tr class="active">
							      ...
							      <td>
							            <input type="text" name="prize_uuid" value="${prizeCheckResult.prize_uuid}" class="form-control"  placeholder="UUID">
							      </td>
							      <td></td>
							      <td>
							      </td>
                    ...
                    <input type="hidden" name="teacher_num" value="${prizeCheckResult.teacher_num}" class="form-control" >
		          <p>
