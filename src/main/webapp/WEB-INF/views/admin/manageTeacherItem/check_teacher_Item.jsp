...
<body>
   <div class="main">
       <h2>教学项目审核</h2>
		   <form class="form-inline" method="post" action="<%=request.getContextPath() %>/admin_item/save_result" >
					  ...
					  <table class="table">
					  		<tr class="active">
							     <td>
							      ...
							      <td>
							           <input type="text" name="result_rank" class="form-control" value="${itemCheckResult.result_rank}"  placeholder="项目等级">
							      </td>
							      <td>
							...
							<tr class="active">
							     ...
							     <td> 
								    ...
								    <label class="radio">
								     ...
								     <c:choose>
								               <c:when test="${itemCheckResult.result_is_ok== 1}">
								                       <script>
								                       $("input[name='result_is_ok']").get(0).checked=true;
								                       </script>
								               </c:when>
								               <c:when test="${itemCheckResult.result_is_ok== 2}">
								                       <script>
							...
							<tr class="active">
							      ...
							      <td>
							            <input type="text" name="item_title" value="${itemCheckResult.item_title}" class="form-control"  placeholder="论文名称">
							      </td>
							      <td></td>
							      <td>
							      </td>
                    ...
                    <input type="hidden" name="teacher_num" value="${itemCheckResult.teacher_num}" class="form-control" >
		          <p>
