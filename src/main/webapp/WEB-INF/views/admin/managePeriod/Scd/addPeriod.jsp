...
<body>
   <div class="main">
       <h2>添加期刊</h2><a href="<%=request.getContextPath() %>/admin_scd/show_excel">批量添加</a>
		   <form class="form-inline" method="post" action="<%=request.getContextPath() %>/admin_scd/add_scd" >
		            <div class="table-responsive">
					  <table class="table">					  																										
                            <tr class="active">
							      ...
							      <td>
							           <input type="text" name = "scd_issn" class="form-control"  placeholder="issn">
							      </td>
							      <td>
							...
							<tr class="active">
							      ...
							      <td>
							           <input type="text" name="scd_cn" class="form-control"  placeholder="CN">
							      </td>
							      <td>
							...
							<tr class="active">
							      ...
							      <td>
							           <input type="text"  name="scd_name" class="form-control"  placeholder="期刊名字">
							      </td>
							      <td>
