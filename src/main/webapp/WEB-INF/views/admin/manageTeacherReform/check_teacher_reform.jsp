...
<body>
   <div class="main">
       <h2>教学教改项目审核</h2>
		   <form class="form-inline" method="post" action="<%=request.getContextPath() %>/admin_reform/save_result" >
					  ...
					  <table class="table">
					  		<tr class="active">
							     <td>
							      ...
							      <td>
							           <input type="text" name="result_ranked" class="form-control" value="${reformCheckResult.result_ranked}"  placeholder="项目等级">
							      </td>
							      <td>
							...
							<tr class="active">
							     ...
							     <td> 
								    ...
								    <label class="radio">
								     ...
								     <c:choose>
								               <c:when test="${reformCheckResult.result_is_ok== 1}">
								                       <script>
								                       $("input[name='result_is_ok']").get(0).checked=true;
								                       </script>
								               </c:when>
								               <c:when test="${reformCheckResult.result_is_ok== 2}">
								                       <script>
							...
							<tr class="active">
							      ...
							      <td>
							            <input type="text" name="reform_title" value="${reformCheckResult.reform_title}" class="form-control"  placeholder="名称">
							      </td>
							      <td></td>
							      <td>
							      </td>
                    ...
                    <input type="hidden" name="teacher_num" value="${reformCheckResult.teacher_num}" class="form-control" >
		          <p>
