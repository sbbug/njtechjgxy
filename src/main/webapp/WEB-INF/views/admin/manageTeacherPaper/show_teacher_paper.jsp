           ...
           <div class="table-responsive">
					  <table class="table">
							...
							<c:forEach items = "${pagePapers}" var = "paper">
							          <tr>
							             <td><a href='<%=request.getContextPath() %>/admin_paper/modify_paper?teacher_num=${paper.teacher_num}'>${paper.teacher_num}</a></td>
							              <td>
							              <c:choose>
							              ...
							              <td><a href='<%=request.getContextPath() %>/admin_paper/download_data?paper_path=${paper.paper_path}'>下载</a></td>
							              <td><a href='<%=request.getContextPath() %>/admin_paper/get_paper_check?paper_title=${paper.paper_title}&teacher_num=${paper.teacher_num}'>审核</a></td>
							          </tr>                                                   
                            </c:forEach>
					       ...
					       <a href="<%=request.getContextPath() %>/admin_paper/show_paper?which=pre">上一页</a>
					 
					       <a href="<%=request.getContextPath() %>/admin_paper/show_paper?which=next">下一页</a>
