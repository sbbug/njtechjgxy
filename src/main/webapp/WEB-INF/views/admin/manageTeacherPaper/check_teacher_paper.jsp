...
<body>
   <div class="main">
       <h2>科研论文审核</h2>
		   <form class="form-inline" method="post" action="<%=request.getContextPath() %>/admin_paper/save_result" >
					  ...
					  <table class="table">
							...
							<tr class="active">
							     ...
							     <td> 
								    ...
								    <label class="radio">
								     ...
								     <c:choose>
								               <c:when test="${paperCheckResult.is_in_peking == 1}">
								                       <script>
								 ...
								 <td>
								  ...
								  <td>
								    ...
								    <label class="radio">
								     ...
								     <c:choose>
								               <c:when test="${paperCheckResult.is_in_scd== 1}">
								                       <script>
							...
							<tr class="active">
							     ...
							     <td> 
								    ...
								    <c:choose>
								               <c:when test="${paperCheckResult.is_in_ssci== 1}">
								                       <script>
								 ...
								 <td>
								  ...
								  <td>
								    ...
								    <label class="radio">
								     ...
								     <c:choose>
								               <c:when test="${paperCheckResult.is_in_own== 1}">
								                       <script>
							...
							<tr class="active">
							      ...
							      <td>
							            <input type="text" name="paper_title" value="${paperCheckResult.paper_title}" class="form-control"  placeholder="论文名称">
							      </td>
							      <td></td>
							      <td>
							      </td>
							...
							<tr class="active">
							   <td> <label class="radio">学院期刊类别: </label></td>
							      ...
							      <td>
                                     ...
                                     $("#static_dropdown").val('${paperCheckResult.result_level}');
                                     </script>
							      </td>
							      <td></td>
							      <td></td>
                    ...
                    <input type="hidden" name="teacher_num" value="${paperCheckResult.teacher_num}" class="form-control" >
		          <p>
